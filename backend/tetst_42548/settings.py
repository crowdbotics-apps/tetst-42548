"""
Django settings for tetst_42548 project.
...
WSGI_APPLICATION = 'tetst_42548.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tetst_42548 API",
    "DESCRIPTION": "API documentation for tetst_42548 App",
    "VERSION": "v1",
}
